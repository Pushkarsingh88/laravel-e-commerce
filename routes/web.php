...
Route::get('/account-order/{order_id}/details', [UserController::class, 'order_detail'])->name('user.order.details');
...
Route::middleware(['auth',AuthAdmin::class])->group(function(){
    ...
    Route::get('/admin/order/{order_id}/details', [AdminController::class, 'order_detail'])->name('admin.order.details');
