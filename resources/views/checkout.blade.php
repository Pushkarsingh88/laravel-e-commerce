            ...
            <div class="checkout-form">
              <div class="billing-info__wrapper">
                ...
                <div class="row mt-5">
                  ...
                  <div class="col-md-6">
                    <div class="form-floating my-3">
                      <input type="text" class="form-control" name="locality" required="" value="{{ old('lacality') }}">
                 ...
                 @if(Session::has('discounts'))
                    <table class="checkout-totals">
                      <tbody>
                        <tr>
                          <th>Subtotal</th>
                          <td class="tex-right">${{Cart::instance('cart')->subtotal() }}</td>
                        </tr>
                        <tr>
                          <th>Discount {{ Session::get('coupon')['code'] }}</th>
                          <td class="tex-right">${{Session::get('discounts')['discount']}}</td>
                        </tr>
                        <tr>
                          <th>Subtotal after discount</th>
                          <td class="tex-right">${{Session::get('discounts')['subtotal']}}</td>
  
                        </tr>
                        <tr>
                          <th>Shipping</th>
                          <td class="tex-right">free </td>
                        </tr>
                        <tr>
                          <th>VAT</th>
                          <td class="tex-right">${{Session::get('discounts')['tax']}}</td>
                        </tr>
                        <tr>
                          <th>Total</th>
                          <td class="tex-right">${{Session::get('discounts')['total']}}</td>
                        </tr>
                      </tbody>
                    </table>
                    @else
                    <table class="checkout-totals">
                      <tbody>
                        ...
                        <tr>
                          <th>SHIPPING</th>
                          <td class="tex-right">Free shipping</td>
                        </tr>
                        <tr>
                          <th>VAT</th>
                          <td class="tex-right">${{Cart::instance('cart')->tax() }}</td>
                          
                        </tr>
                        <tr>
                          <th>TOTAL</th>
                          <td class="tex-right">${{Cart::instance('cart')->total() }}</td>
                        </tr>
                      </tbody>
                    </table>
                    @endif
