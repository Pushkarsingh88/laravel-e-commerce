 ...
 <div class="main-content-inner">
    ...
    <div class="main-content-wrap">
        ...
        enctype="multipart/form-data"  action="{{route('admin.product.update')}}">
            @csrf
            @method('PUT')
            ...
            <div class="wg-box">
                ...
                @error('category_id') <span class="alert alert-danger text-danger">{{$message}}</span> @enderror
                ...
                @error('brand_id') <span class="alert alert-danger text-danger">{{$message}}</span> @enderror
                </div>
                ...
                @error('short_description') <span class="alert alert-danger text-danger">{{$message}}</span> @enderror
                ...
                @error('description') <span class="alert alert-danger text-danger">{{$message}}</span> @enderror
            </div>
            <div class="wg-box">
                <fieldset>
                ...
                @error('images') <span class="alert alert-danger text-danger">{{$message}}</span> @enderror
                ...
                @error('regular_price') <span class="alert alert-danger text-danger">{{$message}}</span> @enderror
                ...
                @error('sale_price') <span class="alert alert-danger text-danger">{{$message}}</span> @enderror
                </div>
                ...
                @error('SKU') <span class="alert alert-danger text-danger">{{$message}}</span> @enderror
                ...
                @error('quantity') <span class="alert alert-danger text-danger">{{$message}}</span> @enderror
                </div>
                ...
                <div class="cols gap22">
                  ...
                  @error('stock_status') <span class="alert alert-danger text-danger">{{$message}}</span> @enderror
                ...
                @error('featured') <span class="alert alert-danger text-danger">{{$message}}</span> @enderror
