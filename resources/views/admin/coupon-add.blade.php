        ...
        <div class="main-content-wrap">
            ...
            <div class="wg-box">
                <form class="form-new-product form-style-1" method="POST" action="{{ route('admin.coupon.store') }}">
                    ...
                    @error('code') <span class="alert alert-dander text-center">{{ $message }}</span> @enderror
                    ...
                    @error('type') <span class="alert alert-dander text-center">{{ $message }}</span> @enderror
                    ...
                    @error('value') <span class="alert alert-dander text-center">{{ $message }}</span> @enderror
                    ...
                    @error('cart_value') <span class="alert alert-dander text-center">{{ $message }}</span> @enderror
                    ...
                    @error('expiry_date') <span class="alert alert-dander text-center">{{ $message }}</span> @enderror
