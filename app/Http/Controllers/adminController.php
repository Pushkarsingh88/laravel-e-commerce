...
class adminController extends Controller
{
    public function index()
    {
      ...
      $dashboardDatas = DB::select("select sum(total) As TotalAmount,
          ...
          $OrderedAmountM  = implode(',', collect($monthlyDatas)->pluck('OrderedAmount')->toArray());
          $DeliveredAmountM = implode(',', collect($monthlyDatas)->pluck('DeliveredAmount')->toArray());
      ...
      return view('admin.index' ,compact('orders', 'dashboardDatas','AmountM','OrderedAmountM','DeliveredAmountM','CanceledAmount',
      ...
      public function product_store(Request $request)
          {
           ...
           $current_timestamp = Carbon::now()->timestamp;
             ...
             $product->save();
             return redirect()->route('admin.product')->with('status', 'protect has been added successfully');
          }
          ...
          public function GenerateProductThumbnailImage($image, $imageName)
          {
            ...
            public function product_update(Request $request)
            {
             ...
             return redirect()->route('admin.product')->with('status', 'protuct has been updated successfully');
     ...
     public function product_delete($id)
        ...
        if(File::exists(public_path('uploads/products').'/'.$product ->image))
           {
            File::delete(public_path('uploads/products').'/'.$product ->image);
             ...
             $product ->delete();
             return redirect()->route('admin.product')->with('status' ,'product has been deleted successfully');
      }
      ...
      public function coupon_store(Request $request)
      {
        $request->validate([
           ...
           return redirect()->route('admin.coupons')->with('status' ,'coupons has been add successfully');
     ...
     public function coupon_update(Request $request)
     {
      $request->validate([
        ...
        'expiry_date' =>'required|date',
         ...
         return redirect()->route('admin.coupons')->with('status' ,'coupons has been upadate successfully'); 
          ...
          public function coupon_delete($id) 
          {
              $coupon = Coupon::find($id);
              $coupon->delete();
         return redirect()->route('admin.coupons')->with('status' ,'coupons has been delete successfully'); 
